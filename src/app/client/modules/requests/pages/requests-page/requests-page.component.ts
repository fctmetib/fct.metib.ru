...
export class RequestsPageComponent implements OnInit, OnDestroy {
  ...
  openBrowserDrawer() {
    // TODO: Закомментировал пока что, потом нужно будет подправить метод по задачам https://www.notion.so/f8bf323fb2b84b4f81db1c5c761f451b?pvs=4#eb903b8e0de943f7925951e112dd370f

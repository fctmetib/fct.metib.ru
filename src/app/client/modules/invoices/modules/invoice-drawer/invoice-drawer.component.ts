...
import {ExtendedClientInvoice, PaymentLink} from '../../interfaces/client.invoice';
  ...
  getCurrentInvoice() {
    ...
    return this.invoicesService.getInvoices({
      ...
      map(invoices => {
        ...
        this.totalSumDutyDebtor = this.invoicesLinks.reduce((acc, link) => acc + link.Shipment.DutyDebtor, 0);

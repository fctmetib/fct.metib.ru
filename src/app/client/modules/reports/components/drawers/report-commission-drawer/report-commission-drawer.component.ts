...
@Component({
  selector: 'mib-report-commission-drawer',
  standalone: true,
  imports: [CommonModule, ReportDrawerLayoutComponent, ReportPeriodDebtorFormComponent, ReactiveFormsModule],
  templateUrl: './report-commission-drawer.component.html',
  styleUrls: ['./report-commission-drawer.component.scss']
})
export class  ReportCommissionDrawerComponent implements OnInit {
  ...
  onReport() {
    ...
    this.reportService.commission({ ...this.form.getRawValue() }).pipe(
      tap(data => {

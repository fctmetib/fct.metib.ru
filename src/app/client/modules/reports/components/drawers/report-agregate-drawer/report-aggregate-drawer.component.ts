...
@Component({
  ...
  templateUrl: './report-aggregate-drawer.component.html',
  styleUrls: ['./report-aggregate-drawer.component.scss']
})
export class ReportAggregateDrawerComponent implements OnInit {
  ...
  onReport() {
    ...
    this.reportService.aggregate({ ...this.form.getRawValue() }).pipe(
      tap(data => {

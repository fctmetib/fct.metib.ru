...
import { TariffsStaticComponent } from './pages-static/tariffs-static/tariffs-static.component';
import { ClientsStaticComponent } from './pages-static/clients-static/clients-static.component';
import { ContactsStaticComponent } from './pages-static/contacts-static/contacts-static.component';
...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: 'tariffs',
        component: TariffsStaticComponent,
        title: 'Тарифы'
      },
      {
        path: 'clients',
        component: ClientsStaticComponent,
        title: 'Клиентам'
      },
      {
        path: 'contacts',
...
@NgModule({
  ...
  declarations: [
    ...
    HomeStaticComponent,
    TariffsStaticComponent,
    ClientsStaticComponent,

...
import { DemandAPIInterface } from '../types/demand-api-data/demand-api-eds.interface';
  ...
  public convertToFormData(dataFromAPI: any) {
    switch (dataFromAPI.Type) {
      case DemandAction.EDS:
        return this._convertEDStoFormData(dataFromAPI);
      case DemandAction.AGENT_FACTORING:
        return null;
    }
  }

  private _convertEDStoFormData(dataFromAPI: any): DemandEDSDataInterface {
